...
ElementOfArray = quick_draw_data_set[randomNumber];

console.log(quick_draw_data_set[randomNumber]);

document.getElementById("draw").innerHTML = "Sketch to be Drawn: " + ElementOfArray;
...
function updateCanvas(){
    ...
    randomNumber = Math.floor((Math.random()*quick_draw_data_set.length)+1);
    console.log(quick_draw_data_set[randomNumber]);
    drawnSketch = quick_draw_data_set[randomNumber];
    document.getElementById('Sketch').innerHTML = 'Sketch to be Drawn' + drawnSketch;
}
